...
../qt-everywhere-src-$1/configure -opensource -confirm-license -release -skip webengine -nomake tests -nomake examples -qt-zlib -qt-libjpeg -qt-libpng -xcb -qt-freetype -qt-pcre -qt-harfbuzz -prefix /opt/Qt-arm64-$1 -xplatform linux-aarch64-gnu-g++ -v -sysroot / -pkg-config
make -j $(($(nproc)+4))
make install
cd /opt
